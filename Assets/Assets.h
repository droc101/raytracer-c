...
extern const unsigned char gzfsh_shader_hud_color[];
extern const unsigned char gzvsh_shader_hud_color[];
extern const unsigned char gzfsh_shader_hud_textured[];
extern const unsigned char gzvsh_shader_hud_textured[];
extern const unsigned char gzfsh_shader_wall[];
extern const unsigned char gzvsh_shader_wall[];

extern const unsigned char gztex_vfx_shadow[];


#define ASSET_COUNT 43
